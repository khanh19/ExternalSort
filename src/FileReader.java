...
public class FileReader {
     ...
     * 
     * @param block the next block
     * @param start position start
     * @param end   position end
     * @throws IOException throw exception when it's wrong
     */
    public void parseRange(byte[] block, 
     ...
     * 
     * @param totalByte the total byte
     */
    ...
    /**
     * the helper function
     * @throws IOException throw when wrong
     */
