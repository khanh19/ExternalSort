...
public class RunStore {
    ...
    public class RunInfo {
         ...
         * 
         * @param beginOff the begin info
         * @param closeOff the end info
         */
        ...
        try {
            ...
            while (convert.hasNext()) {
                ...
                for (int i = 0; i < currBlock.length; i += 16) {
                    Record currRecord = new Record(Arrays.
