...
public class Heap<E extends Comparable<? super E>> {
     ...
     * 
     * @param h
     *            the array of the heapArray
     * @param max
     *            the maximum size of the heapArray
     */
     ...
     * 
     * @param pos
     *            the specific position of the record
    ...
    public void siftdown(int pos) {
        ...
        if (!isLeaf(pos)) {
            ...
            if (heapArray[pos].compareTo(heapArray[left]) > 0 || heapArray[pos]
                .compareTo(heapArray[right]) > 0) {
